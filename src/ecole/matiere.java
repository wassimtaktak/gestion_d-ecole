...
public class matiere extends JFrame {
		...
		public matiere() {
			...
			panel.setBorder( BorderFactory. createTitledBorder( "Informations de la matiére : ") ) ;
			
			JLabel lblNewLabel = new JLabel("id_mati\u00E9re");
			...
			btnNewButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						String requete = "INSERT INTO matiere VALUES ('"+id+"','"+libelle+"')";
							int res = state.executeUpdate(requete);
							if(res!=0){
									affiche();
									JOptionPane.showMessageDialog(null, "matiére ajouté avec succès", "info", JOptionPane.INFORMATION_MESSAGE);
									}
							setVisible( true) ;
							state.close();
			...
			btnNewButton.setIcon(new ImageIcon(matiere.class.getResource("/img/ajouter.png")));
				...
				public void actionPerformed(ActionEvent e) {
					try { 
			            ...
			            if (JOptionPane.showConfirmDialog (null,"confirmer la modification","modification",
			                ...
			                stmn.executeUpdate("UPDATE matiere SET libelle='"+libelletext.getText()+
			                        "' WHERE id_mat= "+idtext.getText());
			                affiche();
			            } 
			...
			btnNewButton_1.setIcon(new ImageIcon(matiere.class.getResource("/img/modifier.gif")));
			...
			btnNewButton_2.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					try {
						Statement stmn;
						stmn= connexion.getconnect().createStatement();
			             if(JOptionPane.showConfirmDialog(null,"attention vous allez supprimer une matière,est ce que vous etes sure?"
			                     ,"supprimer matiere",JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION)
			         
			            if(idtext.getText().length() != 0){
			        stmn.executeUpdate("Delete From matiere where id_mat = "+idtext.getText());
			        affiche();
			             }
			...
			btnNewButton_2.setIcon(new ImageIcon(matiere.class.getResource("/img/supprimer.png")));
			...
			btnNewButton_3.setIcon(new ImageIcon(matiere.class.getResource("/img/sortie.gif")));
